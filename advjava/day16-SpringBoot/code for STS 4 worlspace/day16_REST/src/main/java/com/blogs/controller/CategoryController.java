...
//depcy
	...
	public ResponseEntity<?> getCategoryDetails(@PathVariable Long catId) {
		...
		try {
			...
			Category category = categoryService.getCategoryDetails(catId);
	...
	public ResponseEntity<?> updateCategoryDetails(@PathVariable Long categoryId, @RequestBody Category category) {
